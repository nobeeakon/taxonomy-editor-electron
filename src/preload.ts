...
contextBridge.exposeInMainWorld('database', {
    downloadFile: (args:DownloadFileArgs) => ipcRenderer.invoke('downloadFile', args),
    ...
    saveNodeInfo: (args:SaveNodeInfoArgs) => ipcRenderer.invoke('saveNodeInfo', args),
    saveNodeName: (args:SaveNodeNameArgs) => ipcRenderer.invoke('saveNodeName', args),
})
