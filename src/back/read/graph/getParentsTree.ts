...
const getParentsTree = ({nodeNameWithLanguageCode, includeTarget, searchType, graphData:graphData2}:GetParentsTreeParams) => {
    ...
    const targetNodeInfo:GraphNodeType = graphData2[nodeIndexMap[nodeNameWithLanguageCode]];
